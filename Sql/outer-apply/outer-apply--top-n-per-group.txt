...
-- В случае отсутствия связанных записей в таблице t2 запись таблицы t1 выводится, но при этом в полях таблицы t2 выводится NULL.
-- Вариант с "OUTER APPLY" работает быстрее варианта с "LEFT JOIN" и фильтрацией по "ROW_NUMBER".
