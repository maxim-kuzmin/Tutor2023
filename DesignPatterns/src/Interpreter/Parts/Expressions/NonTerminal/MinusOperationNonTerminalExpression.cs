...
/// </summary>
internal class MinusOperationNonTerminalExpression : IExpression
{
    #region Fields
    ...
    public MinusOperationNonTerminalExpression(IExpression leftOperandExpression, IExpression rightOperandExpression)
    {
